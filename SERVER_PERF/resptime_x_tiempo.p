...
set terminal png
set output "resptime_tiempo.png"
...
#plot "serv_apache.tsv" every ::2 using 2:5 title 'response time' with points
plot "serv_apache.tsv" using 2:5 title 'response time' with points
